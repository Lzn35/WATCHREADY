"""
Database migration to add security-related tables
"""
...
def upgrade(connection):
    ...
    connection.execute(text("""
        CREATE INDEX IF NOT EXISTS idx_failed_login_attempts_user_id 
    ...
    connection.execute(text("""
        CREATE INDEX IF NOT EXISTS idx_failed_login_attempts_attempt_time 
        ON failed_login_attempts(attempt_time)
    """))
...
def downgrade(connection):
    ...
    connection.execute(text("DROP TABLE IF EXISTS failed_login_attempts"))
    connection.execute(text("DROP TABLE IF EXISTS password_history"))
